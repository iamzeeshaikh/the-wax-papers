        ...
        <div className="container-wide grid lg:grid-cols-[1fr_1.05fr] gap-8 items-center">
          ...
          <div className="max-w-xl">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="flex items-center gap-1 text-sm font-medium" style={{ color: "var(--color-gold-text)" }}>
            ...
            <div className="flex flex-wrap gap-5">
              {TRUST_BADGES.map((b) => (
                ...
                >
                  <svg className="w-4 h-4 shrink-0" style={{ color: "var(--color-gold-text)" }} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            {relatedWithImages.map((r) => (
              <Link key={r.href} href={r.href} className="card group block">
                ...
                <div className="p-3.5">
                  ...
                  <span className="text-xs font-medium inline-flex items-center gap-1" style={{ color: "var(--color-gold-text)" }}>
                    See specifications
